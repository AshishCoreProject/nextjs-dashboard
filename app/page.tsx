      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          <Image
            ...
            alt={
              'Screenshot of the dashboard project showing in the desktop screen'
            }
          />
          <Image
            src="/hero-mobile.png"
            ...
            alt="Screenshot of the dashboard project showing in the mobile"
          />
        </div>
      </div>
    </main>
